...
/**
 * Provides the local service utility for Ruolo. This utility wraps
 * <code>prenotazione.service.impl.RuoloLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RuoloLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>prenotazione.service.impl.RuoloLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Ruolo addRuolo(Ruolo ruolo) {
		return getService().addRuolo(ruolo);
	}
	 ...
	 */
	public static Ruolo createRuolo(int id) {
		return getService().createRuolo(id);
	}
	 ...
	 */
	public static Ruolo deleteRuolo(int id) throws PortalException {
		return getService().deleteRuolo(id);
	}
	 ...
	 * @return the ruolo that was removed
	 */
	public static Ruolo deleteRuolo(Ruolo ruolo) {
		return getService().deleteRuolo(ruolo);
	}
	...
	public static Ruolo fetchRuolo(int id) {
		return getService().fetchRuolo(id);
	}
	 ...
	 * @throws PortalException if a ruolo with the primary key could not be found
	 */
	public static Ruolo getRuolo(int id) throws PortalException {
		return getService().getRuolo(id);
	}
	 ...
	 */
	public static List<Ruolo> getRuolos(int start, int end) {
		return getService().getRuolos(start, end);
	}
	 ...
	 */
	public static int getRuolosCount() {
		return getService().getRuolosCount();
	}
	 ...
	 */
	public static Ruolo updateRuolo(Ruolo ruolo) {
		return getService().updateRuolo(ruolo);
	}

	public static RuoloLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<RuoloLocalService> _serviceSnapshot =
		new Snapshot<>(RuoloLocalServiceUtil.class, RuoloLocalService.class);
