 ...
 * <code>prenotazione.service.impl.UtenteLocalServiceImpl</code> and
...
public class UtenteLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>prenotazione.service.impl.UtenteLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Utente createUtente(long id) {
		return getService().createUtente(id);
	}
	 ...
	 */
	public static Utente deleteUtente(long id) throws PortalException {
		return getService().deleteUtente(id);
	}
	...
	public static Utente fetchUtente(long id) {
		return getService().fetchUtente(id);
	}
	 ...
	 * @throws PortalException if a utente with the primary key could not be found
	 */
	public static Utente getUtente(long id) throws PortalException {
		return getService().getUtente(id);
	}
	...
	private static final Snapshot<UtenteLocalService> _serviceSnapshot =
		new Snapshot<>(UtenteLocalServiceUtil.class, UtenteLocalService.class);
